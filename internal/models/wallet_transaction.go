...
type WalletTransaction struct {
	...
	FreelancerProfileID uuid.UUID     `gorm:"type:uuid;index;not null" json:"freelancer_profile_id"`
	...
	// Relation
	FreelancerProfile *FreelancerProfile `gorm:"foreignKey:FreelancerProfileID" json:"-"`
}
